    ...
    <tr>
      <td colspan="2">
        <table cellpadding="3" cellspacing="0" width="100%">
          <tr>
            <td align="center" bgcolor="black" width="10%">이 름</td>
            <td bgcolor="black"><%=name%></td>
            <td align="center" bgcolor="black" width="10%">등록날짜</td>
            <td bgcolor="black"><%=regdate%></td>
          </tr>
          <tr>
            <td align="center" bgcolor="black">제 목</td>
            <td bgcolor="black" colspan="3"><%=subject%></td>
          </tr>
          <tr>
            <td align="center" bgcolor="black">첨부파일</td>
